...
- [ ] Schema: `reports` table (kind daily|weekly|org, period, body, pdf_url, delivery tracking)
- [ ] Agent eval harness + scored set: severity agreement >= 85%; briefs grounded + complete
- [ ] Daily "UAE Pulse" + weekly sector digest auto-generated by cron and delivered
- [ ] Dashboard: Briefs page + Reports page, deployed live
- **DoD:** briefs pass eval suite; daily/weekly reports auto-generated and delivered
      (delivery needs the Phase 4 channel key)
