...
const LINKS = [
  ...
  { href: "/topics", label: "Topics", icon: "M4 6h16M4 12h16M4 18h7" },
  ...
  { href: "/feed", label: "Feed", icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H15" },
];
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-3">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent/10 text-accent text-sm font-bold shadow-glow transition-all group-hover:shadow-glow-lg group-hover:bg-accent/15">
              B
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-positive/20 bg-positive/5 px-2.5 py-1 text-[10px] font-medium text-positive">
